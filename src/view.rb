...
class Application
    ...
    def menu 
        ...
        @menu.add_cascade :label => 'Produtos',
                          :menu => @sb_menu
    ...
    def start_widgets
        ...
        # // configure widgets
        @lb_title.configure :font => @font_title, 
                            :bg => BG, 
                            :fg => MKC
        
        @bt_final.configure :font => @font_media, 
                            :fg => FG, 
                            :bg => BCB
        
        @bt_cance.configure :font => @font_media, 
                            :fg => FG, 
                            :bg => BCB 
        
        @bt_retir.configure :font => @font_media, 
                            :fg => FG, 
                            :bg => BCB 
        
        @bt_liber.configure :font => @font_media, 
                            :fg => FG, 
                            :bg => BCB
        
        @lb_codig.configure :font => @font_media,
                            :bg => BG,
                            :fg => FG
        ...
        @lb_preco.configure :font => @font_media, 
                            :bg => BG2
        
        @lb_p_atu.configure :font => @font_title, 
                            :bg => BG2, 
                            :fg => 'blue'
        
        @lb_total.configure :font => @font_media, 
                            :bg => BG2
        
        @lb_p_tot.configure :font => @font_title, 
                            :bg => BG2, 
                            :fg => 'orange'
        
        @lb_show_.configure :font => @font_minim, 
                            :bg => BG,  
                            :fg => 'blue'
        
        # // position widgets
        @lb_title.pack :fill => 'x'
        @bt_final.pack :fill => 'x', 
                        :expand => true, 
                        :padx => 30

        @bt_cance.pack :fill => 'x', 
                        :expand => true, 
                        :padx => 30

        @bt_retir.pack :fill => 'x', 
                        :expand => true, 
                        :padx => 30

        @bt_liber.pack :fill => 'x', 
                        :expand => true, 
                        :padx => 30
