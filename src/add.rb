# // script de rederizamento da janela de controle de banco de dados
# // trabalha em conjunto com 'crud.rb'

require 'tk'
require_relative 'crud'
require_relative 'loadconf'

# // função unica que engloba toda a janela de manipulação
def manipulation
    ...
    def cad 
        ...
        begin 
            ...
            Tk::Message.messageBox :icon => 'error', :title => 'Preço inválido', 
        ...
        if exist[0].nil?
            if cod != "" and pro != "" and pre != ""
                ...
                Tk::Message.messageBox :icon => 'info', :title => 'Cadastrado!', 
                ...
                Tk::Message.messageBox :icon => 'error', :title => 'Campo em branco', 
                    :message =>'Não pode haver campos em branco'
                return
            end
        else
            Tk::Message.messageBox :icon => 'error', :title => 'Erro', 
                        :message =>
                    """
    ...
    # // prepara os  updates nos cadastros e chama 'conf_update'
    def edit
        @ent1.delete 0, 100
        @ent2.delete 0, 100
        @ent3.delete 0, 100 
    ...
    def conf_update
        ...
        Tk::Message.messageBox :icon => 'info', :title => 'Alterado',
    ...
    def remove 
        begin
            ...
            resp   = Tk::Message.messageBox :icon => 'warning', :title => 'Excluir', :type => 'yesno',
            ...
            Tk::Message.messageBox :icon => 'info', :title => 'Excluir', 
    ...
    Tk::Label.new frame1 do
        ...
        font fonte
        text 'Cod' 
        pack :anchor => 's', :fill => 'x',:side => 'left', :padx => 50 
    end
    ...
    @lb_in = Tk::Listbox.new frame3 do
        width 600
        height 15;
        pack :expand => true, :fill => 'x', :pady => 10 
    end
